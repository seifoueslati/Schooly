...
@media all { 
    ...
    .admit-card-bottom p{
        text-align: <?php echo isset($admit_setting->bottom_text_align) && $admit_setting->bottom_text_align != '' ? $admit_setting->bottom_text_align : 'center'; ?>;       
        color: <?php echo isset($admit_setting->bottom_text_color) && $admit_setting->bottom_text_color != '' ? $admit_setting->bottom_text_color : '#ffffff'; ?> !important;       
    }
}
